...
import getRecipe from '../../../_lib/recipe/getRecipe';
async function page({params}) {
  ...
  return (
    <main className='shadow-xl p-10 rounded-xl w-full'>
      ...
      <h2 className='font-semibold text-sm text-center pb-3'>Recipe</h2>
        ...
        <div className='flex justify-center'>
          <div>
          <p className=' pb-2 text-sm font-semibold pt-12'>{recipe.recipe_categories.name}</p>
